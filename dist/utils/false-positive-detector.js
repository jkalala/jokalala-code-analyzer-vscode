...
exports.falsePositiveDetector = exports.FalsePositiveDetector = void 0;
/**
...
class FalsePositiveDetector {
    constructor() {
        ...
        Object.defineProperty(this, "userSuppressions", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        }); // User-suppressed vulnerability IDs
     ...
     */
    filterVulnerabilities(vulns, fullCode) {
        const filtered = [];
        const removed = [];
        const warned = [];
     ...
     */
    suppressVulnerability(vulnId) {
        this.userSuppressions.add(vulnId);
    }
    /**
     * Remove user suppression
     */
    unsuppressVulnerability(vulnId) {
     ...
     */
    getPatternsForType(vulnType) {
        return this.patterns.filter(p => p.misclassificationTypes.some(mt => vulnType.toLowerCase().includes(mt.toLowerCase())));
    }
}
exports.FalsePositiveDetector = FalsePositiveDetector;
/**
 * Singleton instance
 */
exports.falsePositiveDetector = new FalsePositiveDetector();
//# sourceMappingURL=false-positive-detector.js.map